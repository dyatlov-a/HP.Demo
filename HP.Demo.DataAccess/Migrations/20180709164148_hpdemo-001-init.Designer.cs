...
namespace HP.Demo.DataAccess.Migrations
{
    ...
    [Migration("20180709164148_hpdemo-001-init")]
    partial class hpdemo001init
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HP.Demo.Domain.Models.Identity.Group", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<int>("Functionals");
                    ...
                    b.HasData(
                        new { Id = new Guid("5d52ad35-a76b-427d-a5b2-0a650e285644"), Functionals = 1, GroupType = 0, Name = "Users" },
                        new { Id = new Guid("cdba21fe-cbe9-4939-8ff4-e1854e574c22"), Functionals = 62, GroupType = 1, Name = "Admins" }
                    );
                });

            modelBuilder.Entity("HP.Demo.Domain.Models.Identity.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("HP.Demo.Domain.Models.Identity.UserGroup", b =>
                {
                    ...
                    b.ToTable("xUserGroups");

                    b.HasData(
                        new { UserId = new Guid("b13f0125-3252-4f3c-9721-43b88ece43e5"), GroupId = new Guid("5d52ad35-a76b-427d-a5b2-0a650e285644") },
                        new { UserId = new Guid("b13f0125-3252-4f3c-9721-43b88ece43e5"), GroupId = new Guid("cdba21fe-cbe9-4939-8ff4-e1854e574c22") }
                    );
                });

            modelBuilder.Entity("HP.Demo.Domain.Models.Identity.UserGroup", b =>
                {
                    b.HasOne("HP.Demo.Domain.Models.Identity.Group", "Group")
                        .WithMany()
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("HP.Demo.Domain.Models.Identity.User", "User")
                        .WithMany("UserGroups")
